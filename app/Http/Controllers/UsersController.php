...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate(
            ...
            [
                'user_nama' => 'Harus diisi!',
                'user_email' => 'Harus diisi!',
                'user_password' => 'Harus diisi!',
                'user_alamat' => 'Harus diisi!',
                'user_hp' => 'Harus diisi!',
                'user_pos' => 'Harus diisi!',
                'user_role' => 'Harus diisi!',
                'user_aktif' => 'Harus diisi!'
            ]
        );
